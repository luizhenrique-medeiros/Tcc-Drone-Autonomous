...
class DeliveryPoint(TimestampMixin, Base):
    ...
    map_provider: Mapped[str] = mapped_column(String(40), default="maptiler", nullable=False)
    map_type: Mapped[str] = mapped_column(String(30), default="hybrid", nullable=False)
